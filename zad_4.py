...
def first_two_numbers_bigger_than_third(
        number1: int, number2: int, number3: int) -> bool:
...
if the_outcome:
    print(f"The sum of the [{a}] and [{b}] is: [{a+b}], "
          f"which is bigger or equal to [{c}].")
else:
    print(f"The sum of [{a}] and [{b}] is p{a+b}], "
          f"which is less than [{c}].")
